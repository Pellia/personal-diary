        ...
        <div className="max-w-3xl mx-auto p-4">
            <div className="mb-4 flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                    <input type="date" className="border border-gray-300 rounded-lg p-2 w-1/2" value={startDate} onChange={(e) => setStartDate(e.target.value)} />
                    <input type="date" className="border border-gray-300 rounded-lg p-2 w-1/2" value={endDate} onChange={(e) => setEndDate(e.target.value)} />
                </div>
            </div>
